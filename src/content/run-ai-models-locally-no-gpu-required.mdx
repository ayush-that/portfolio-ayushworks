...
![](/blog-images/run-ai-models-locally-no-gpu-required/image-2.png)

GPT4ALL is available for Windows, macOS, and Linux. Here's how to install it on different systems:

**1\. Windows and macOS:**

![](/blog-images/run-ai-models-locally-no-gpu-required/image-3.png)
...
![](/blog-images/run-ai-models-locally-no-gpu-required/image-6.png)
